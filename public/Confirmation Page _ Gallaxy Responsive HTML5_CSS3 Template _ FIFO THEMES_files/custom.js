...
/*----------------------------------------------------*/
	...
	//Google map
	jQuery('#maps').gMap({
		address: "Carretera Virgen, San Juan del Sur, Nicaragua",
		zoom: 14,
		markers: [{
			latitude: 11.25500,
			longitude: -85.873000,
			html: "<h4>Precioustimber</h4>San Juan del Sur, Nicaragua",
			popup: true
		}]
	});
...
$("#contact").submit(function (e) {
    ...
    var text = $("#text").val();
    var dataString = 'name=' + name + '&email=' + email + '&address='+ address + '&city='+ city + '&zip='+ zip + '&country='+ country + '&state='+ state + '&tele='+ tele + '&refer='+ refer + '&subject=' + subject + '&text=' + text;
